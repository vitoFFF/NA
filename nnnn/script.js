...
function updateLocation() {
  navigator.geolocation.watchPosition(function(position) {
      ...
      if (typeof userMarker !== 'undefined') {
        ...
        userMarker = L.circleMarker([userLat, userLng], { color: 'red', fillColor: 'cyan', fillOpacity: 1, radius: 24 }).addTo(map).bindPopup('Your Location');
      }
      ...
      for (var i = 0; i < polylineCoords.length - 2; i++) { // Exclude start and end points (p0 and last)
          ...
          switch (i) {
              ...
              case 3:
                  ...
                  if (d4 > 170) {
                    console.log("You are less than 170 meters from checkpoint 4.");
                }
                  break;
              case 4:
      ...
      document.getElementById("distance").textContent = "Distance to Checkpoint 1: " + d1.toFixed(2) + " meters";  
